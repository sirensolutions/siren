...
public class Loader {
  ...
  public Loader(HttpSolrServer solrServer, int batchSize,
  ...
  public static void main(String[] args) {
    ...
    Loader loader = new Loader(new HttpSolrServer(cmd.getOptionValue(URL_OPT, DEFAULT_SOLR_URL)),
        ...
        cmd.getOptionValue(EXT_OPT, DEFAULT_JSON_EXTENSION),
    ...
    if (parser.hasNext()) {
      ...
      if (parser.hasNext()) {
        throw new IllegalArgumentException(
            "file " + filename + " contains more than one object");
      }
      return 1;
    } else {
      return 0;
  ...
  private static void showExtendHelpExit(Options options) {
    ...
    System.out.println("\nNote: only file or directory names option is mandatory\n" + "Examples:\n"
        ...
        + USAGE_BASE + " -" + BATCH_OPT + " " + 128 + " -" + INPUT_FILE_OPT + " file.json\n" + "    "
        + USAGE_BASE + " -" + NO_EXT_CHECK_OPT + " export-directory\n");
