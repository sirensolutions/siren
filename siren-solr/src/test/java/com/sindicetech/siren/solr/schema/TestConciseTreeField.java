...
public class TestConciseTreeField extends SolrServerTestCase {
  ...
  public void testConciseSirenFieldType() throws Exception {
    ...
    assertTrue(tmp instanceof ConciseTreeField);

    json = schema.getField("concise-tree-attribute-wildcard");
    assertNotNull(json);
    tmp = json.getType();
    assertTrue(tmp instanceof ConciseTreeField);
  }
